...
namespace Console.ConsoleScripts
{
    public class Console : MonoBehaviour
    {
        #region Configuration
        public static readonly string ModName = "Console"; // Your Mod Name
        public static readonly string ModVersion = "1.0.0"; // Your Mod Version
